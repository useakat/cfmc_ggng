      subroutine get_chjacob_diagram_sch(P)
C     ****************************************************
C     
...
C     Amplitude(s) for diagram number 19
         ...
         AA(1) = AA(1) +AMP(9)*DCONJG(AMP(9))     ! 7: (3,(4,5))
         AA(2) = AA(2) +AMP(15)*DCONJG(AMP(15))   ! 8: (4,(3,5))
         AA(3) = AA(3) +AMP(21)*DCONJG(AMP(21))   ! 9: (5,(3,4))
         AA(4) = AA(4) +AMP(25)*DCONJG(AMP(25)) ! 10: ((4,5),3)
         AA(5) = AA(5) +AMP(26)*DCONJG(AMP(26)) ! 11: ((3,5),4)
         AA(6) = AA(6) +AMP(27)*DCONJG(AMP(27)) ! 12: ((3,4),5)
      ENDDO
...
c      CH(1) = AA(1) +AA(2) +AA(3) +AA(4) +AA(5) +AA(6)
