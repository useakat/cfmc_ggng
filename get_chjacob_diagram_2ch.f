      subroutine get_chjacob_diagram_2ch(P)
C     ****************************************************
C     
...
c         AA(13) = AA(13) +AMP(1)*DCONJG(AMP(1)) ! 13: s((3,4),5)
c         AA(14) = AA(14) +AMP(2)*DCONJG(AMP(2)) ! 14: s((3,5),4)
c         AA(15) = AA(15) +AMP(3)*DCONJG(AMP(3)) ! 15: s((4,5),3)
c         AA(1) = AA(1) +AMP(9)*DCONJG(AMP(9))     ! 7: (3,(4,5))
c         AA(2) = AA(2) +AMP(15)*DCONJG(AMP(15))   ! 8: (4,(3,5))
c         AA(3) = AA(3) +AMP(21)*DCONJG(AMP(21))   ! 9: (5,(3,4))
c         AA(4) = AA(4) +AMP(25)*DCONJG(AMP(25)) ! 10: ((4,5),3)
c         AA(5) = AA(5) +AMP(26)*DCONJG(AMP(26)) ! 11: ((3,5),4)
c         AA(6) = AA(6) +AMP(27)*DCONJG(AMP(27)) ! 12: ((3,4),5)
      ENDDO
...
c      CH(1) = AA(2) +AA(4) +AA(10) +AA(11)
c      CH(2) = AA(1) +AA(6) +AA(7) +AA(12)
c      CH(3) = AA(3) +AA(5) +AA(8) +AA(9)
