...
while [ $j -ne $nplot ];do
    ...
    echo "'Events/${run_me}/${plot_unwgt[$j]}.dat' u 1:(\$2/${binsize[$j]}) t '${run_me}_{unwgt}' w histep lt 1 lc rgb 'blue' lw 3" >> $gnu_file
#    echo "'Events/${run}/${plot_unwgt[$j]}.dat' every::0::0 notitle w histep lt 1 lw 0" >> $gnu_file
