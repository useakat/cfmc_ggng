...
c      include 'base1.h'
 ...
 9200 format(1x,'!',f10.1,' !',2(g14.6,' !'),g14.3,' !',i4,' !',
     &           i4,' !')
      ...
      write(lustdo,'()')
      write(lustdo,'(5x,a)') '================================='
      write(lustdo,'(5x,a)') '  g g --> 3g (Input Parameters)'
      write(lustdo,'(5x,a)') '================================='
      write(lustdo,'()')
      ...
      write(lustdo,'()')
      write(lustdo,'(5x,a)') '================================='
      write(lustdo,'(5x,a)') '  g g --> 3g (Bases Parameters)'
      write(lustdo,'(5x,a)') '================================='
      write(lustdo,'()')
      ...
      write(lustdo,'()')
      write(lustdo,'(5x,a)') '================================'
      write(lustdo,'(5x,a)') '  g g --> 3g (Kinematic Cuts)'
      write(lustdo,'(5x,a)') '================================'
      write(lustdo,'()')
      write(lustdo,'(9x,a,f8.1)') 'Pt      = ',ptcut
      write(lustdo,'(9x,a,f8.1)') 'Eta     = ',ayecut
c      write(lustdo,'(9x,a,f8.1)') 'Pt_jj   = ',ptcut
      write(lustdo,'(9x,a,f8.1)') 'Delta_R = ',rcut
      write(lustdo,'()')
      
      write(lustdo,600) w0,estim,sigma,100.d0*sigma/estim,ctime,it1,it2
 600  format(/
     &     5x,' ================================',/,
     &     5x,'    g g --> 3g (Cross section)',/,
     &     5x,' ================================',//,
     &     5x,'   Ecm [GeV]          = ',f10.1,/,
